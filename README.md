...
|         | Aplicativo mobile de logística sustentável desenvolvido para rastrear operações de transporte, monitorar emissões de GEE, otimizar rotas e fornecer indicadores ESG em tempo real.                                                            | TypeScript                       | React Native / Expo        | 🚧 Em desenvolvimento |
|         | Vorqen é uma plataforma integrada de automação logística, focada na gestão operacional de fretes, prospecção de motoristas, validações, emissão documental e acompanhamento das operações em um único ambiente. Acesso: https://vorqen.com.br | JavaScript / TypeScript / Python | Next.js / NestJS / FastAPI | 🚧 Em desenvolvimento |
